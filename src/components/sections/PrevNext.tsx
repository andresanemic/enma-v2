  ...
  return (
    ...
    >
      ...
      <div className={`absolute inset-0 flex flex-col justify-between p-6 ${isPrev ? "items-start text-left" : "items-end text-right"}`}>
        <span className={`flex items-center gap-2 font-body text-[11px] font-semibold uppercase tracking-[0.18em] text-cream/85 transition-colors duration-200 ${accentHover} ${isPrev ? "" : "flex-row-reverse"}`}>
        ...
        <div>
          <p className="font-body text-[11px] uppercase tracking-[0.14em] text-cream/65">{item.eyebrow}</p>
