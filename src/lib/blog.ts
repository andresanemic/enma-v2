...
export const ARTICLES: Article[] = [
  ...
  },
  {
    ...
    body: [
      ...
      { type: "p", spans: [`No me gusta la palabra experto; prefiero especialista. Un socio tecnológico estratégico al que recurres porque sabe lo que hace y porque está donde tú estás.`] },
